...
const getEvenElements = (elements) => {
  return elements.filter((element, id) => id % 2 === 0)
}

const getOddElements = (elements) => {
  return elements.filter((element, id) => id % 2 !== 0)
}
...
function FilmTabs({film, comments}) {
  ...
  return (
    <>
      ...
      {activTab === Tabs.DETAILS && <div className="film-card__text film-card__row">
      ...
      {activTab === Tabs.REVIEWS && <div className="film-card__reviews film-card__row">
        {comments.length && <>
